...
class ConverterTest {
   ...
   void GeneratingExpression() {
       assertAll(
               ...
               ()-> assertEquals("<p style=\"font-family:Arial;color:Red;\">Welcome</p>",Converter.parse("ADD PARAGRAPH WITH TEXT \"Welcome\" AND WITH FONT \"Arial\" AND WITH COLOR \"Red\"")),
               ()-> assertEquals("<a href=\"http://google.com\">Search</a>",Converter.parse("ADD LINK WITH TEXT \"Search\" AND WITH LINK \"http://google.com")),
               ()-> assertEquals("<a href=\"http://gmail.com\" style=\"color:Green;\">Email</a>",Converter.parse("ADD LINK WITH TEXT \"Email\" AND WITH LINK \"http://gmail.com\" AND WITH COLOR \"Green"))
